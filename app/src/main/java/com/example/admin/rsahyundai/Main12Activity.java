...
public class Main12Activity extends AppCompatActivity {
    ...
    int[] IMAGES1 = {R.drawable.silver,R.drawable.lb1,R.drawable.silver};
    String[] Names = new String[]{"SX","SX AT","SX AT"};
    String[] Color = {"Sleek Silver","Polar White","Sleek Silver"};
    String[] Number = {"1","4","1"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ListView listView = (ListView)findViewById(R.id.listView12);
