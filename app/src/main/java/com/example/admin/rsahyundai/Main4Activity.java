...
public class Main4Activity extends AppCompatActivity {
    ...
    int[] IMAGES1 = {R.drawable.lb,R.drawable.silver,R.drawable.lb,R.drawable.silver,R.drawable.lb,R.drawable.fiery};
    String[] Names = new String[]{"Magna 1.2 CRDi","Magna 1.2 CRDi","Sportz 1.2 CRDi","Sportz 1.2 CRDi (0)","Asta 1.2","Asta 1.2"};
    String[] Color = {"Polar White","Sleek Silver","Polar White","Sleek Silver","Polar White","Fiery Red"};
    String[] Number = {"2","1","2","2","1","1"};
