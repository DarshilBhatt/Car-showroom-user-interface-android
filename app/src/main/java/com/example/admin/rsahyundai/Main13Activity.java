...
public class Main13Activity extends AppCompatActivity {
    ...
    int[] IMAGES1 = {R.drawable.lb,R.drawable.black};
    String[] Names = new String[]{"E+","E+"};
    String[] Color = {"Polar White","Thunder Black"};
    String[] Number = {"1","2"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ListView listView = (ListView)findViewById(R.id.listView13);
