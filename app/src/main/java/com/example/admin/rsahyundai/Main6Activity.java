...
public class Main6Activity extends AppCompatActivity {
    ...
    int[] IMAGES1 = {R.drawable.lb,R.drawable.lb,R.drawable.lb,R.drawable.mblue};
    String[] Names = new String[]{"Magna Executive","Sportz","Asta (o)","Asta (o)"};
    String[] Color = {"Polar White","Polar White","Polar White","Marina Blue"};
    String[] Number = {"4","1","4","1"};
