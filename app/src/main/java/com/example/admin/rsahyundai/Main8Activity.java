...
public class Main8Activity extends AppCompatActivity {
    ...
    int[] IMAGES1 = {R.drawable.lb,R.drawable.stadust,R.drawable.lb,R.drawable.lb1};
    String[] Names = new String[]{"E+","E+","S","SX"};
    String[] Color = {"Polar White","Star Dust","Polar White","Polar White"};
    String[] Number = {"2","1","2","1"};
